...
func (c *serverStreamingClient) GetServerResponse(ctx context.Context, in *Number, opts ...grpc.CallOption) (ServerStreaming_GetServerResponseClient, error) {
	stream, err := c.cc.NewStream(ctx, &ServerStreaming_ServiceDesc.Streams[0], "/protos.ServerStreaming/GetServerResponse", opts...)
	if err != nil {
		return nil, err
	}
...
var ServerStreaming_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "protos.ServerStreaming",
	...
	Metadata: "protos/serverstreaming.proto",
}
